...
def update_files(directory):
    ...
    print(f"{HEADER}Checking header and source files for pragmas and filename comments...{ENDC}")
...
def print_summary(stats):
    ...
    print(f"{OKGREEN}│{OKYELLOW} Files Checked       {OKGREEN}│{ENDC} {str(stats['files_checked']).rjust(5)} {OKGREEN}│{ENDC}")
    print(f"{OKGREEN}│{OKYELLOW} Pragmas Added       {OKGREEN}│{ENDC} {str(stats['pragmas_added']).rjust(5)}{ENDC} {OKGREEN}│{ENDC}")
    print(f"{OKGREEN}│{OKYELLOW} Comments Added      {OKGREEN}│{ENDC} {str(stats['filenames_added']).rjust(5)}{ENDC} {OKGREEN}│{ENDC}")
    print(f"{OKGREEN}│{OKYELLOW} Comments Fixed      {OKGREEN}│{ENDC} {str(stats['filenames_corrected']).rjust(5)}{ENDC} {OKGREEN}│{ENDC}")
    print(f"{OKGREEN}│{FAIL}{BOLD} Total Files Updated{OKGREEN} │{ENDC} {FAIL}{str(stats['files_updated']).rjust(5)}{ENDC} {OKGREEN}│{ENDC}")
    print(f"{OKGREEN}└─────────────────────┴───────┘{ENDC}")
